plot2 <- function(power_df,project_folder) {
    plot_file <- file.path(project_folder,paste("plot2.png",sep=""))
...
# plot dataframe in project folder
     ...
     plot_ds <- plot2(power_data_subset,project_folder_name)
    log(script_r,"[#6] ",plot_ds," complete and written to project folder")
